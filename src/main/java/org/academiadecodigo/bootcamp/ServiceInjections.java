...
public class ServiceInjections {
    ...
    public void load() {
        ...
        quoteService.addQuote(new Quote("\"Existem duas maneiras de construir um projeto de software.\n Uma maneira é tornar tão simples que, \n obviamente, não há deficiências. E o outro caminho \n é tornar tão complicado que não haja deficiências óbvias. \"\n- C.A.R. Hoare"));
        quoteService.addQuote(new Quote("\"A maioria dos bons programadores programa, \n não porque esperam receber pagamento ou reconhecimento pelo público, \n mas porque é divertido programar.\"- Linus Torvalds"));
        quoteService.addQuote(new Quote("\"Iterar é humano, recursar é divino.\"- L. Peter Deutsch"));
        quoteService.addQuote(new Quote("\"Às vezes vale a pena ficar na cama na segunda-feira, \n ao invés de passar o resto da semana a corrigir o código de segunda-feira\"\n - Christopher Thompson"));
